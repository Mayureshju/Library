...
<div class="container-fluid">
	...
	<div class="col-sm-8">
	<center><font color="red" size="3">Memeber List</font><center><br>
	<table class="table">
	<tr>
	<td><font color="red"><center><b>Name</b></center></font></td>
	<td><font color="red"><center><b>Address</b></center></font></td>
	<td><font color="red"><center><b>Mobile No</b></center></font></td>
	<td><font color="red"><center><b>Address</b></center></font></td>
	</tr>
	<?php
	foreach($res as $r1)
	{
		?>
			<tr>
					...
					<td><font color="white"><center><b><?= $r1->mno; ?></b></center></font></td>
